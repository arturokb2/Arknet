...
class History:
    ...
    def get_History_data(self):
        ...
        data['dskz3'] = {'kod': sluchay.dskz3.kod if sluchay.dskz3 != None else '',
                        'naim': sluchay.dskz3.naim[:50] if sluchay.dskz3 != None else ''}
        data['ksg_osn2'] = sluchay.ksg_osn2.code_usl_kz if sluchay.ksg_osn2 != None else ''
        data['code_usl2'] = sluchay.code_usl2.kod if sluchay.code_usl2 != None else ''
        data['code_usl_name2'] = sluchay.code_usl2.name if sluchay.code_usl2 != None else ''
        data['ksg_osn2_all'] = sluchay.ksg_osn2.ksg if sluchay.ksg_osn2 != None else ''
        data['oopkk2'] = sluchay.oopkk2.kod if sluchay.oopkk2 != None else ''
        data['ksg_osn_2_helper'] = ''
