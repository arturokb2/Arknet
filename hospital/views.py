...
def check_ksg(request):
    ...
    if err_bool == False:
            ...
            mkb_10_list = [] if set(mkb_10_list) == {''} else mkb_10_list
            mkb_10_2_list = [] if set(mkb_10_2_list) == {''} else mkb_10_2_list
            mkb_10_3_list = [] if set(mkb_10_3_list) == {''} else mkb_10_3_list
            code_usl_list = [] if set(code_usl_list) == {''} else code_usl_list
            duration_list = [] if set(duration_list) == {''} else duration_list
            w_list = [] if set(w_list) == {''} else w_list
            age_list = [] if set(age_list) == {''} else age_list
            ikk_list = [] if set(ikk_list) == {''} else ikk_list
