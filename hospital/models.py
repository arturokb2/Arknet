...
class Sluchay(models.Model):
    ...
    ksg_osn2 = models.ForeignKey(group_kc_group, on_delete=models.SET_NULL, blank=True, null=True, related_name='ksg_osn2')
    dskz3 = models.ForeignKey(Ds, on_delete=models.SET_NULL, blank=True, null=True, related_name='dskz3')
    code_usl2 = models.ForeignKey(T003, on_delete=models.SET_NULL, blank=True, null=True, related_name='code_usl2')
    oopkk2 = models.ForeignKey(group_kc_dkk, on_delete=models.SET_NULL, blank=True, null=True, related_name='oopkk2')
